    ...
    return (
        <div>
            <Navbar bg="light" expand="lg">
                <Link to='/' style={{height:"2.5%" , width:"2.5%"}}><img style={{ height: "100%", width: "100%", marginRight: 10 }} src="https://i.pinimg.com/736x/54/51/75/54517514b7e9c8c21cb1526176c30732.jpg" /> </Link>
                <Link to='/'><Navbar.Brand href="#home" style={{ marginRight: 40 }}>Movies Best</Navbar.Brand></Link>
